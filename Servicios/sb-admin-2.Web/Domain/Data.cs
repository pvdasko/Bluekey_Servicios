...
namespace Servicios.Domain
{
    public class Data
    {
        public IEnumerable<Navbar> navbarItems()
        {
            ...
            var menu = new List<Navbar>();
            menu.Add(new Navbar { Id = 1, nameOption = "Inicio", controller = "Home", action = "Index", imageClass = "glyphicon glyphicon-home", status = true, isParent = false, parentId = 0 });
            menu.Add(new Navbar { Id = 2, nameOption = "Estado de cuenta", controller = "Home", action = "Tables", imageClass = "glyphicon glyphicon-credit-card", status = true, isParent = false, parentId = 0 });
            menu.Add(new Navbar { Id = 3, nameOption = "Requerimientos", controller = "Home", action = "Forms", imageClass = "glyphicon glyphicon-list-alt", status = true, isParent = false, parentId = 0 });
            menu.Add(new Navbar { Id = 4, nameOption = "Concierge", imageClass = "glyphicon glyphicon-comment", status = true, isParent = false, parentId = 0 });
            menu.Add(new Navbar { Id = 5, nameOption = "Promociones", imageClass = "glyphicon glyphicon-gift", status = true, isParent = false, parentId = 0 });
            menu.Add(new Navbar { Id = 6, nameOption = "Sitios de interes", imageClass = "glyphicon glyphicon-map-marker", status = true, isParent = false, parentId = 0 });
            menu.Add(new Navbar { Id = 7, nameOption = "Check In", imageClass = "glyphicon glyphicon-check", status = true, isParent = false, parentId = 0 });
